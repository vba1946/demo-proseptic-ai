"""Индексация базы знаний — единая коллекция с метаданными категорий."""
import os, re
...
def main():
    ...
    print(f'septiki_knowledge: {len(all_chunks)} чанков (категории: {set(m["category"] for m in all_metas)})')
